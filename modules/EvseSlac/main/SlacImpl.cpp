...
static SlacIO slac_io;
static std::mutex comm_mtx;
static std::promise<void> module_ready;
static fsm::sync::PosixController<EvseFSM::StateHandleType> fsm_ctrl;
...
void SlacImpl::run() {
    // initialize everything and wait for ready
    EvseFSM fsm(slac_io);
